...
if (result) {
  ...
  return (
    ...
    <div className='relative w-full max-w-md mx-auto rounded-2xl bg-[#181818]/90 shadow-2xl border boder-[#333] px-8 py-10 mt-4 flex flex-col items-center min-h-[480px]'>
        ...
        <div className='w-full flex flex-col flex-1'>
            <div className='mb-6 flex-1'>
                <h3 className='text-lg font-semibold text-white text-center'>{steps[step].label}</h3>
            ...
            <div className='flex justify-between items-center mt-6'>
                ...
                onClick={handleBack}
                disabled={step == 0}
                className='px-4 py-2 rounded-lg font-semibold transition border-2 border-2 border-[#444] text-white bg-[#181818] hover:bg-[#232323]'>
                    Back
                </button>
                <button type= 'button' 
                onClick={
                    step === steps.length -1 ?generateRecommendation : handleNext}
                disabled={!inputs[steps[step].name] || isLoading}
                className='px-4 py-2 rounded-lg font-semibold transition border-2 border-[#e50914] text-white bg-[#e50914] hover:bg-[#b0060f] ml-2'>
