    ...
    <div className="min-h-screen bg-cover bg-center bg-no-repeat px-4 md:px-8 py-5" style={{
        ...
        <div className='max-w-[450px] w-full bg-black bg-opacity-75 rounded px-8 py-14 mx-auto mt-8 '>
            ...
            <form onSubmit={handleLogin} className='flex flex-col space-y-4'>
                ...
                <button type='submit' disabled= {isLoading} className='w-full h-[50px] bg-[#e50914] text-white rounded text-base font-semibold hover:bg-[#f40612] transition-all duration-300 text-base hover:opacity-90 cursor-pointer'>Sign In</button>
            </form>
